...
gftools-find-features.py ./data/Lora-Regular.ttf
...
# Scripts which require credentials
...
# Scripts which should be deprecated
# gftools-sanity-check.py ./data/mock_googlefonts/ofl/abel/ Very old, does not follow new spec
# gftools fix-vf-meta ./data/Lora-Roman-VF.ttf use damastat make or patch ttx files instead
