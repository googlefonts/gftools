...
def _output_upstream_yaml(
    ...
    if not file_or_family:
        ...
        upstream_conf_yaml, _, _ = _get_upstream_info(
            file_or_family,
            is_file,
            yes,
            quiet,
            ...
            while True:  # repl
                if not edit:
                    (
                        ...
                        license_dir,
                        gf_dir_content,
                    ) = _get_upstream_info(file_or_family, is_file, yes, quiet)
                else:
                    (
                        upstream_conf_yaml,
                        license_dir,
